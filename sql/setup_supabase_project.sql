...
-- RPC: crear_usuario (hash en servidor, validaciones y control de rol)
...
BEGIN
    ...
    -- Restringir creación de administradores
...
-- Inserciones: permitir crear usuarios no administradores desde cliente (anon/authenticated)
...
-- Inserciones de administradores: solo si el solicitante es admin autenticado
